...
3. Use the `FaceClient` to interact with the Face API.  You can do things such as:
	...
	...And much more.  Take a look at the [Sample Apps](/tree/master/Xamarin.Cognitive.Face/Xamarin.Cognitive.Face.Sample) to see the usage of these and more features.
